...
export default function VanguardRetirement() {
  ...
  let endpoint = `http://localhost:3001/vanguardRetirement`;
  let { setVanguardRetirementTotal  } = useContext(AppContext);
  ...
  useEffect(() => {
    ...
    //TODO, why do I have setURL?
    //setUrl(endpoint);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [accountsRefresh]);

  useEffect(() => {
    setVanguardRetirementTotal(totalValue)
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [totalValue]);
